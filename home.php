...
<div class="popup" id="popup">
  ...
  <button onclick="closePopup(),Popclosed()">Close</button>
</div>
...
<script>
  ...
  <div class="newsalert" style="width: 80%; margin: 0 auto;">
    <h5 class="alert" style="color: orange; text-align: center;">Important News</h5>
    <marquee behavior="scroll" direction="left">
        <h3 class="news" style="color: red;"><?php echo $row['Blog']; ?></h3>
    </marquee>
</div>
