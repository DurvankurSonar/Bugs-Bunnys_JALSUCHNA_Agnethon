	...
	<div id="wrapper">
		<div class="height-100v d-flex align-items-center justify-content-center">
							...
							<!-- <ul class="nav nav-tabs nav-tabs-primary top-icon nav-justified">
								...
								<li class="nav-item">
									<a href="javascript:void();" data-target="#profile" data-toggle="pill"
										class="nav-link active"><i class="icon-user"></i> <span class="hidden-xs"> <a href="newvel.php">Valvemen
											Login</span></a>
								</li>
							...
							<div class="tab-content p-3">
								<div class="tab-pane active" id="profile">
									<div class="card-content p-2">
										...
										<div class="card-title text-uppercase text-center py-3"> Valvemen Login</div>
		    <form action="" method="post">
			  ...
			  <div class="form-group">
			   <div class="position-relative has-icon-right">
				  <label for="exampleInputPassword" required="" class="sr-only">Password</label>
				  <input type="password" name="password" id="exampleInputPassword" class="form-control form-control-rounded" placeholder="Enter your Password">
				  <div class="form-control-position">
					  <i class="icon-lock"></i>
				  </div>
			   </div>
              ...
              <a href="home.php"> <button type="submit" name="log_in"
...
include "join.php";
    if(isset($_POST['log_in']))
    {
        ...
        $log=mysqli_query($x,"select * from val_form where Email='$email' and Password='$password'") or die (mysqli_error($x));
